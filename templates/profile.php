...
<div class="userwall-wp-profile-wrapper">
	<div class="userwall-wp-profile-header">
		<div class="userwall-wp-profile-avatar">
			<img src="<?php echo esc_attr( get_userwall_wp_profile_data( 'avatar' ) ); ?>" alt="<?php // translators: Avatar alt text placeholder. ?><?php esc_attr( sprintf( __( 'Avatar of %s', 'userwall-wp' ), get_userwall_wp_profile_data( 'display_name' ) ) ); ?>" />
		</div>
