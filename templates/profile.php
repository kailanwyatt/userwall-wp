<div class="userwall-wp-profile-wrapper">
    ...
    <div class="userwall-wp-profile-tabs">
        <div class="userwall-wp-profile-tab-item">
            <span class="userwall-wp-profile-posts-count">30</span>
            <span class="userwall-wp-profile-posts-label"><?php echo esc_html( 'Posts', 'userwall-wp' ); ?></span>
        </div>
    </div>
